...
@SourceType(value = "FacebookARP", label = "Facebook",uiConfig = "facebook-layout.json")
public class FacebookConf extends AbstractArpConf<FacebookConf> {
  private static final String ARP_FILENAME = "arp/implementation/facebook-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.facebook.FacebookDriver";
